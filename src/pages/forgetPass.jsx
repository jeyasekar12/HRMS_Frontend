            ...
            <div className="w-full min-h-screen flex items-center justify-center">
                <form onSubmit={handleSubmit(onSubmit)} className="w-full md:w-[450px] bg-white px-10 pt-14 pb-14 flex flex-col gap-5" >
                    ...
                    <div>
                        ...
                        <p className="text-1xl text-[#666666] mt-3 mb-3">Enter your email address to get the<br /> password reset link.</p>
                    </div>
                    ...
                    <button type="submit" className="w-full h-10 bg-[#FF698D] text-white rounded-md">Password Reset</button>


                    <p className=" text-[#999DA3]">
                        <Link to="/log-in"> <span className="text-[#FF698D]">Back to Login</span></Link>
                    </p>
